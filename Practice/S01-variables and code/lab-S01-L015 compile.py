...
4. Dla każdej formuły z listy formuł:
...
6. Skopiuj pętlę z punktu (3) i dokonaj modyfikacji:
...
7. Uruchom program i porównaj czasy przed i po optymalizacji
'''

### wykonanie wg instrukcji / samemu jestem za głupi jeszcze
