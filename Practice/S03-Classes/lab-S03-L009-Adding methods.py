...
Cake.export_1_cake_to_html(
    cake01, 'G:\.Cwiczenia\BackEnd\Python\Kurs Udemy\Kurs2\Practice\S03-Classes\Data\S03-L009\static\cake01.html')

# class method:
Cake.export_all_cakes_to_html = types.MethodType(
    export_all_cakes_to_html, Cake)
Cake.export_all_cakes_to_html(
    'G:\.Cwiczenia\BackEnd\Python\Kurs Udemy\Kurs2\Practice\S03-Classes\Data\S03-L009\class\\all_cakes.html')

# instance method:
for c in Cake.bakery_offer:
    c.export_this_cake_to_html = types.MethodType(export_this_cake_to_html, c)
for c in Cake.bakery_offer:
    c.export_this_cake_to_html(
        'G:\.Cwiczenia\BackEnd\Python\Kurs Udemy\Kurs2\Practice\S03-Classes\Data\S03-L009\instance\{}.html'.format(c.name.replace(' ', '_')))
