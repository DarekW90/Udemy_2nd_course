...
cake01.save_to_file(
    f'G:\Cwiczenia\BackEnd\Python\Kurs Udemy\Kurs2\Practice\S03-Classes\Data\S03-L007\cake01.bakery')
cake02.save_to_file(
    f'G:\Cwiczenia\BackEnd\Python\Kurs Udemy\Kurs2\Practice\S03-Classes\Data\S03-L007\cake02.bakery')

cake05 = Cake.read_from_file(
    f'G:\Cwiczenia\BackEnd\Python\Kurs Udemy\Kurs2\Practice\S03-Classes\Data\S03-L007\cake01.bakery')
cake05.show_info()

print(Cake.get_bakery_files(
    f'G:\Cwiczenia\BackEnd\Python\Kurs Udemy\Kurs2\Practice\S03-Classes\Data\S03-L007'))
