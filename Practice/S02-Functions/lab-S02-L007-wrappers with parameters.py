...
@wrapper_with_log_file('FILE_CREATE', r'G:\Cwiczenia\BackEnd\Python\Kurs Udemy\Kurs2\Practice\S02-Functions\Data\S02-L007\file_create.txt')
def create_file(path):
    print('creating file {}'.format(path))
    open(path,'w+')


@wrapper_with_log_file('FILE_DELETE', r'G:\Cwiczenia\BackEnd\Python\Kurs Udemy\Kurs2\Practice\S02-Functions\Data\S02-L007\file_delete.txt')
def delete_file(path):
    print('deleting file {}'.format(path))
    os.remove(path)

create_file(r'G:\Cwiczenia\BackEnd\Python\Kurs Udemy\Kurs2\Practice\S02-Functions\Data\S02-L007\dummy_file.txt')
create_file(r'G:\Cwiczenia\BackEnd\Python\Kurs Udemy\Kurs2\Practice\S02-Functions\Data\S02-L007\dummy_file.txt')
create_file(r'G:\Cwiczenia\BackEnd\Python\Kurs Udemy\Kurs2\Practice\S02-Functions\Data\S02-L007\dummy_file.txt')
create_file(r'G:\Cwiczenia\BackEnd\Python\Kurs Udemy\Kurs2\Practice\S02-Functions\Data\S02-L007\dummy_file.txt')